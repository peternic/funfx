...
<pre><code>require 'funfx/firewatir'
...
flex = browser.flex_app("DemoApp") # DemoApp is the id of the HTML element embedding the Flex app.
</code></pre>
...
* REMOVE HARDCODED DemoApp id in generated_elements.rb + generally improve ugly id logic 
...
* Extract a Codec class
* Get rid of ARG_SEP - use varargs instead.
* Exclude FunFx.swc from RDoc
